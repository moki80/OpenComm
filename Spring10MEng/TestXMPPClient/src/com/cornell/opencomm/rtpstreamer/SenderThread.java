...
/**
 * Takes audio frames from a queue and sends them over RTP.
 * @author Curtis
...
public class SenderThread extends Thread {
	...
	/**
	 * Synchronization correction value, in milliseconds. It accelerates the
	...
	/**
	 * Constructs a SenderThread.
	 * 
	 * @param input_stream
	 *            the stream to be sent
	 * @param do_sync
	 *            whether time synchronization must be performed by the
	 *            SenderThread, or it is performed by the InputStream (e.g.
	 ...
	 * @param que 
	 *            the queue to take samples from
	 */
	 ...
	 * @param millisecs synchronization adjustment time */
	...
	/** number of times packet is sent */
	public static int m;
