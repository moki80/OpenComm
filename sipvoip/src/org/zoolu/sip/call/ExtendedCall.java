...
public class ExtendedCall extends Call implements ExtendedInviteDialogListener {
	...
	public void call(String r_user, String from, String contact, String sdp, String route) {
		...
		if (sdp != null)
			local_sdp = sdp;
		if (local_sdp != null)
			dialog.invite(r_user, from, contact, local_sdp, route);
		else
			dialog.inviteWithoutOffer(r_user, from, contact, route);
	}
