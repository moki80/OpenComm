 ...
 * itself) and N output lines (OutputStreams). <p/> Each output line has an
 * identifier (Object) used as key when adding or removing the line.
 */
public class SplitterLine extends OutputStream {
	...
	/** Adds a new line. */
	public void addLine(Object id, OutputStream os) { // System.err.println("SL:
														// add: "+id+" "+os);
		output_lines.put(id, os);
	}

	/** Removes a line. */
	public void removeLine(Object id) { // System.err.println("SL: remove:
										// "+id);
	 ...
	 * stream.
	 */
	public void write(byte[] b) throws IOException { // System.err.print("*");
		super.write(b);
		// System.err.print("@");
	}
	 ...
	 * this output stream.
	 */
	public void write(byte[] b, int off, int len) throws IOException { // System.err.print("*");
	...
	public void write(int b) throws IOException { /*
		...
		for (Enumeration e = output_lines.keys(); e.hasMoreElements();) {
			...
			try {
				...
				System.err.println("SL(" + splitter_id
						+ "): ERROR while writing on line " + line_id);
				ex.printStackTrace();
