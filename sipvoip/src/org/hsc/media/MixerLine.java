 ...
 * output line (the MixerLine itself). <p/> Each input line has an identifier
 * (Object) used as key when adding or removing the line.
 */
public class MixerLine extends InputStream {
	...
	/** Adds a new line. */
	public void addLine(Object id, InputStream is) { // System.err.println("ML:
														// add: "+id+" "+is);
		input_lines.put(id, is);
	}

	/** Removes a line. */
	public void removeLine(Object id) { // System.err.println("ML: remove:
										// "+id);
	...
	public boolean markSupported() {
		...
		for (Enumeration e = input_lines.elements(); e.hasMoreElements();) {
			if (!((InputStream) e.nextElement()).markSupported())
				supported = false;
		}
		return supported;
	}
	 ...
	 * buffer array b.
	 */
	public int read(byte[] b) throws IOException { // System.err.print("o");
	 ...
	 * bytes.
	 */
	public int read(byte[] b, int off, int len) throws IOException { // System.err.print("o");
